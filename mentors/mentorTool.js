$(function() {
    ...
    function selectItem(item) {
        ...
        if(mentorList.length === 0) {
            yourMentor.html("<h3>No Mentor Assigned!</h3><p>I'm sorry, there is currently no mentor assigned to that department. Please contact <a href='mailto:gkaminsk@pcc.edu'>Greg Kaminksi</a> for more information about the Distance Learning Faculty Mentor program at PCC.</p>");

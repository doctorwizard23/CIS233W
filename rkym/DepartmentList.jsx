...
export default class DepartmentList extends React.Component {
    ...
    render() {
        ...
        const departments = this.props.departments.sort(compareDepartments.bind(this)).map(department => <DepartmentBlock key={department.dept} department={department} mentorIds={this.props.mentorIds} />);

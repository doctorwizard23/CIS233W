lookupDictDefinition = function() {
        ...
        for(i = 0; i < definitions.length; i++) {
            if(i == 0 
                ...
                || (definitions[i].pos != definitions[i - 1].pos)) {
                    ...
                    html += "<b>" + definitions[i].lemma + "</b> (" + partsOfSpeech[definitions[i].pos] + "):<ol class='dict_list'>";
            }
    ...
    function fetchWords(words, selection) {
        ...
        httpRequest.open("GET", "http://localhost/CIS233W/dict/word_lookup.php?word=" + words, true);
        httpRequest.send();
    }
